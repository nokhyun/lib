package com.example.nokhyunlib.compose
...
fun Text(
    ...
    // TODO fontFamily, fontSize 설정을 사용자가 선택권 패스하도록 수정필요.
...
@Composable
fun RowScope.BottomNavigationRippleItem(
    selected: Boolean,
    onClick: () -> Unit,
    ...
    val ripple = rememberRipple(bounded = false, color = Color.Gray)
